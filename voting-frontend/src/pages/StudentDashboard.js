...
import {
  ...
  FaClipboardList, FaHourglassHalf, FaCheckCircle, FaSignOutAlt, FaPercentage 
} from 'react-icons/fa';
      ...
      <section className="tu-section">
        ...
        <div className="qa-grid">
          ...
          <button className="qa-card qa-green" onClick={() => handleAction('result')}>
           ...
           <button className="qa-card qa-indigo" onClick={() => handleAction('probability')}>
             <div className="qa-icon"><FaPercentage /></div>
             <div className="qa-title">Probability</div>
             <div className="qa-sub">Win chances</div>
           </button>
